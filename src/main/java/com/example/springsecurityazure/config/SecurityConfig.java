...
//                            response.setHeader("Access-Control-Allow-Origin", "http://127.0.0.1:5500");
                            response.setHeader("Access-Control-Allow-Origin", "https://lemon-coast-0167bad03.3.azurestaticapps.net");
                            response.setStatus(HttpStatus.OK.value());
                            response.setHeader("Location", "https://accounts.google.com/Logout?&continue=https://lemon-coast-0167bad03.3.azurestaticapps.net");
                        })
                        .logoutUrl("/logout")
                )
                .csrf(csrf -> csrf
...
//                            corsConfiguration.setAllowedOrigins(List.of("http://127.0.0.1:5500"));
                            corsConfiguration.setAllowedOrigins(List.of("https://lemon-coast-0167bad03.3.azurestaticapps.net"));
